...
_lr_productions = [
  ...
  ('data -> DATA_OPEN topic_collection sites_collection DATA_CLOSE','data',4,'p_data','xmlparse.py',12),
  ('sites_collection -> SITES_OPEN sites SITES_CLOSE','sites_collection',3,'p_sites_collection','xmlparse.py',15),
  ('sites -> sites site','sites',2,'p_sites','xmlparse.py',18),
  ('sites -> site','sites',1,'p_sites','xmlparse.py',19),
  ('site -> SITE_OPEN url title topic_collection record_collection SITE_CLOSE','site',6,'p_site','xmlparse.py',23),
  ('topic_collection -> TOPICS_OPEN topics TOPICS_CLOSE','topic_collection',3,'p_topic_collection','xmlparse.py',27),
  ('topics -> topics topic','topics',2,'p_topics','xmlparse.py',31),
  ('topics -> topic','topics',1,'p_topics','xmlparse.py',32),
  ('topic -> TOPIC_OPEN TEXT TOPIC_CLOSE','topic',3,'p_topic','xmlparse.py',36),
  ('url -> URL_OPEN URL URL_CLOSE','url',3,'p_url','xmlparse.py',41),
  ('title -> TITLE_OPEN TEXT TITLE_CLOSE','title',3,'p_title','xmlparse.py',45),
  ('record_collection -> RECORDS_OPEN records RECORDS_CLOSE','record_collection',3,'p_record_collection','xmlparse.py',48),
  ('records -> records record','records',2,'p_records','xmlparse.py',52),
  ('records -> record','records',1,'p_records','xmlparse.py',53),
  ('record -> RECORD_OPEN idate fdate region numvisits RECORD_CLOSE','record',6,'p_record','xmlparse.py',57),
  ('idate -> IDATE_OPEN DATE IDATE_CLOSE','idate',3,'p_idate','xmlparse.py',61),
  ('fdate -> FDATE_OPEN DATE FDATE_CLOSE','fdate',3,'p_fdate','xmlparse.py',65),
  ('region -> REGION_OPEN REGION REGION_CLOSE','region',3,'p_region','xmlparse.py',69),
  ('numvisits -> NUMBER_OF_VISITS_OPEN NUMBER_OF_VISITS NUMBER_OF_VISITS_CLOSE','numvisits',3,'p_numvisits','xmlparse.py',73),
]
